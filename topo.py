...
class NetworkTopo(Topo):
  ...
  def build(self, **_opts):
    ...
    self.addLink(s2, r1, intfName2='r1-eth2', params2={'ip': '10.1.0.1/24'})

    # Adding hosts specifying the default route
    d1 = self.addHost(name='d1', ip='10.0.0.251/24')
    d2 = self.addHost(name='d2', ip='10.0.0.252/24')
    d3 = self.addHost(name='d3', ip='10.1.0.253/24')
    d4 = self.addHost(name='d4', ip='10.1.0.254/24')
...
def addRoute(hosts):
  ...
  for host in hosts:
    host.cmd('ip route add {}/16 via {}'.format(gatwayIPs[str(host)][0],
                                                gatwayIPs[str(host)][1]))
